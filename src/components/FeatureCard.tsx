  ...
  return (
    <div
      className={cn(
        ...
        "bg-card border border-border rounded-lg p-4 sm:p-5 md:p-6 text-center",
        "shadow-card hover:shadow-glow transition-all duration-300",
        "group cursor-default",
        className
      )}
    >
      <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 mx-auto mb-3 sm:mb-3.5 md:mb-4 rounded-full bg-charcoal-lighter flex items-center justify-center text-lulu-red group-hover:scale-110 transition-transform duration-300">
        {icon}
      </div>
